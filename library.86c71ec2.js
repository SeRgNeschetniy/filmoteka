 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Me(e="[DEFAULT]"){const t=ke.get(e);if(!t)throw xe.create("no-app",{appName:e});return t}function Le(e,t,n){var i;let r=null!==(i=Ie[e])&&void 0!==i?i:e;n&&(r+=`-${n}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${r}" with version "${t}":`];return s&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Se.warn(e.join(" "))}Ne(new J(`${r}-version`,(()=>({library:r,version:t})),"VERSION"))}let De=null;function Be(){return De||(De=ye("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw xe.create("idb-open",{originalErrorMessage:e.message})}))),De}async function Ue(e,t){var n;try{const n=(await Be()).transaction("firebase-heartbeat-store","readwrite"),i=n.objectStore("firebase-heartbeat-store");return await i.put(t,Fe(e)),n.done}catch(e){if(e instanceof S)Se.warn(e.message);else{const t=xe.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});Se.warn(t.message)}}}function Fe(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dt(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(jt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Bt(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(zt(t))return"Blackberry";if(qt(t))return"Webos";if(Ut(t))return"Safari";if((t.includes("chrome/")||Ft(t))&&!t.includes("edge/"))return"Chrome";if($t(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Bt(e=y()){return/firefox\//i.test(e)}function Ut(e=y()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Ft(e=y()){return/crios\//i.test(e)}function jt(e=y()){return/iemobile/i.test(e)}function $t(e=y()){return/android/i.test(e)}function zt(e=y()){return/blackberry/i.test(e)}function qt(e=y()){return/webos/i.test(e)}function Wt(e=y()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Ht(){return T()&&10===document.documentMode}function Vt(e=y()){return Wt(e)||$t(e)||qt(e)||zt(e)||/windows phone/i.test(e)||jt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Ds=Ls||(Ls={}))[Ds.OVERWRITE=0]="OVERWRITE",Ds[Ds.MERGE=1]="MERGE",Ds[Ds.ACK_USER_WRITE=2]="ACK_USER_WRITE",Ds[Ds.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Us{operationForChild(e){if(Mr(this.path)){if(null!=this.affectedTree.value)return c(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Sr(e));return new Us(Ir(),t,this.revert)}}return c(kr(this.path)===e,"operationForChild called for unrelated child."),new Us(Rr(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Ls.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Fs{operationForChild(e){return Mr(this.path)?new Fs(this.source,Ir(),this.snap.getImmediateChild(e)):new Fs(this.source,Rr(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Ls.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Lo,Do;function Bo(e,t,n,i){const r=t.source.queryId;if(null!==r){const s=e.views.get(r);return c(null!=s,"SyncTree gave us an op for an invalid query."),Ao(s,t,n,i)}{let r=[];for(const s of e.views.values())r=r.concat(Ao(s,t,n,i));return r}}function Uo(e,t){let n=null;for(const i of e.views.values())n=n||xo(i,t);return n}class Fo{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Ys(null),this.pendingWriteTree_={visibleWrites:Js.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function jo(e,t,n,i,r){return function(e,t,n,i,r){c(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=Xs(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?Vo(e,new Fs({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function $o(e,t,n,i){!function(e,t,n,i){c(i>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:i,visible:!0}),e.visibleWrites=Qs(e.visibleWrites,t,n),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i);const r=Ys.fromObject(n);return Vo(e,new js({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,r))}function zo(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(lo(e.pendingWriteTree_,t)){let t=new Ys(null);return null!=i.snap?t=t.set(Ir(),!0):Zi(i.children,(e=>{t=t.set(new Sr(e),!0)})),Vo(e,new Us(i.path,t,n))}return[]}function qo(e,t,n){return Vo(e,new Fs({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Wo(e,t,n,i){const r=Yo(e,i);if(null!=r){const i=Jo(r),s=i.path,o=i.queryId,a=Lr(s,t);return Xo(e,s,new Fs(Bs(o),a,n))}return[]}function Ho(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Uo(n,Lr(e,t));if(i)return i}));return po(i,t,r,n,!0)}function Vo(e,t){return Go(t,e.syncPointTree_,null,ao(e.pendingWriteTree_,Ir()))}function Go(e,t,n,i){if(Mr(e.path))return Ko(e,t,n,i);{const r=t.get(Ir());null==n&&null!=r&&(n=Uo(r,Ir()));let s=[];const o=kr(e.path),a=e.operationForChild(o),l=t.children.get(o);if(l&&a){const e=n?n.getImmediateChild(o):null,t=wo(i,o);s=s.concat(Go(a,l,e,t))}return r&&(s=s.concat(Bo(r,e,i,n))),s}}function Ko(e,t,n,i){const r=t.get(Ir());null==n&&null!=r&&(n=Uo(r,Ir()));let s=[];return t.children.inorderTraversal(((t,r)=>{const o=n?n.getImmediateChild(t):null,a=wo(i,t),l=e.operationForChild(t);l&&(s=s.concat(Ko(l,r,o,a)))})),r&&(s=s.concat(Bo(r,e,i,n))),s}function Yo(e,t){return e.tagToQueryMap.get(t)}function Jo(e){const t=e.indexOf("$");return c(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Sr(e.substr(0,t))}}function Xo(e,t,n){const i=e.syncPointTree_.get(t);c(i,"Missing sync point for query tag that we're tracking");return Bo(i,n,ao(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ia{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function ka(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Br(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Pa(e,t,n){ka(e,n),Ra(e,(e=>Ur(e,t)||Ur(t,e)))}function Ra(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Na(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Na(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Fi&&zi("event: "+n.toString()),ir(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
